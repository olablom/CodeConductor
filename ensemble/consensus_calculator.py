...
class ConsensusCalculator:
    ...
    def calculate_consensus(self, results: List[QueryResult]) -> ConsensusResult:
        ...
        for field in all_fields:
            ...
            field_consensus, field_confidence, field_disagreements = self._consensus_for_field(
                field, field_values, parsed_responses
            )
    ...
    def _consensus_for_field(
        ...
        if field in ['complexity']:
            ...
            return self._consensus_for_generic_field(field, valid_values, parsed_responses)
