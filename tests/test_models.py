    ...
    for agent_type, prompt in test_prompts.items():
        ...
        if selected_models:
            ...
            if "codestral" in model.lower():
                print(f"    Expected TTFT: ~0.3s")
                print(f"    Expected tokens/s: 35-45")
            elif "gemma" in model.lower():
                print(f"    Expected TTFT: ~0.6s")
                print(f"    Expected tokens/s: 55-60")
            elif "phi" in model.lower():
                print(f"    Expected TTFT: ~0.12s")
                print(f"    Expected tokens/s: 80-100")
            else:
                print(f"    Expected TTFT: ~0.5s")
                print(f"    Expected tokens/s: 40-50")
