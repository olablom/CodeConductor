...
async def main():
    ...
    try:
        ...
        debate_responses = await asyncio.wait_for(
            debate.conduct_debate(user_prompt, timeout_per_turn=180.0),  # 3 minutes per turn
        ...
        print("Debate transcript saved to local_debate_transcript.yaml and local_debate_transcript.json")
