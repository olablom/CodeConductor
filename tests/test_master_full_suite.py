...
class MasterTestSuite:
    ...
    async def initialize(self):
        ...
        agents = [
            ...
            LocalAIAgent("architect", "You are a software architect who focuses on design patterns."),
    ...
    async def test_debate_system_performance(self):
        ...
        test_cases = [
            ...
            ("react_component", "Create a React component for a todo list with add/delete functionality"),
            ("sql_query", "Write a SQL query to find the top 10 customers by total purchase amount"),
            ("bug_fix", "Fix a Python function that has a division by zero error"),
            ("algorithm", "Implement a function to find the longest palindromic substring"),
            ("data_processing", "Create a function to process CSV data and calculate statistics")
        ]
    ...
    async def test_performance_benchmarks(self):
        ...
        long_request = SingleModelRequest(task_description="Write a detailed explanation of machine learning algorithms")
        start_time = time.time()
...
async def main():
    ...
    parser.add_argument("--agents", default="coder architect tester reviewer", 
    ...
    parser.add_argument("--k", type=int, default=3, 
                       help="Self-consistency voting (k)")
