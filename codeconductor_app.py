            ...
            if generated_code.strip():
                with st.spinner("Validating code..."):
                    try:
                        ...
                        compliance_items = [
                            ("Syntax Valid", result.compliance.get("syntax_valid", False)),
                            ("Type Hints", result.compliance.get("has_type_hints", False)),
                            ("Docstrings", result.compliance.get("has_docstrings", False)),
                            ("Error Handling", result.compliance.get("has_error_handling", False)),
                            ("FastAPI Patterns", result.compliance.get("follows_fastapi_patterns", False)),
                            ("Code Style", result.compliance.get("code_style_ok", False)),
                        ]
                        ...
                        if result.is_valid:
                            st.success("🎉 Code validation passed! Your code meets the project standards.")
                        else:
