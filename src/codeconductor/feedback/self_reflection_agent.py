...
class SelfReflectionAgent:
    ...
    def extract_code(self, response: str) -> str:
        ...
        for line in lines:
            ...
            if ('def ' in line or 'import ' in line or 'from ' in line or 
                'class ' in line or 'app = ' in line or 'Flask(' in line):
                in_code = True
                code_started = True
            ...
            if in_code and line.strip():
                ...
                break
            elif code_started and not ('def ' in line or 'import ' in line or 'from ' in line or 
                                     'class ' in line or 'app = ' in line or 'Flask(' in line or
