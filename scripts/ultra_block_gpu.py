...
def ultra_block_gpu():
    ...
    def blocked_import(name, *args, **kwargs):
        ...
        blocked_modules = [
            'torch', 'torch.cuda', 'torch.cuda.is_available',
            'transformers', 'sentence_transformers', 'sentence_transformers.SentenceTransformer',
            'langchain_community.embeddings.huggingface', 'langchain_community.embeddings.huggingface.HuggingFaceEmbeddings',
            'langchain_community.vectorstores.chroma', 'langchain_community.vectorstores.chroma.Chroma',
            'langchain_community.vectorstores.faiss', 'langchain_community.vectorstores.faiss.FAISS',
            'cuda', 'cudnn', 'cublas', 'cudart'
        ]
...
def test_blocking():
    ...
    try:
        ...
        print(f"✅ sentence_transformers imported (type: {type(sentence_transformers)})")
    except Exception as e:
